...
return [
    ...
    'default_produce_timeout_ms' => env('KAFKA_PRODUCE_DEFAULT_TIMEOUT_MS', 3000),

    // Новые топики для типов лотерей
    ...
    // DLQ топики
    'dlq_tickets_topic' => env('KAFKA_NLU_DLQ_TICKETS_TOPIC', 'dlq_tickets_v1'),
    'dlq_schedules_topic' => env('KAFKA_NLU_DLQ_SCHEDULES_TOPIC', 'dlq_schedules_v1'),
    ...
    'tickets' => [
        ...
        'consumer_group_id' => env('KAFKA_NLU_CONSUMER_GROUP_ID', 'cg_draw_service'),
    ],
];
